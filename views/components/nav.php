...
<nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/login" class="bg-violet-600 text-white hover:bg-violet-800 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Login</a>
                <?php  } ?>
                </div>
            </div>
            </div>
            ...
            <div x-data="{ open: false }" class="ml-4 flex items-center md:ml-6">
                ...
                <div>
                    ...
                    <span @click="open = !open" class="absolute -inset-1.5"></span>
                ...
                <div x-show="open" @click.outside="open=false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                    ...
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0"><?php echo is_logged_in() ? $_SESSION['user']['email'] : 'Not Logged In'; ?></a>
                    <?php if (is_logged_in()){ ?>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white"><?php echo is_logged_in() ? $_SESSION['user']['email'] : 'Not Logged In'; ?></a>
            <?php if (is_logged_in()){ ?>
