...
<main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <button class="bg-blue-500 p-2 text-white font-bold rounded">
            <a href="/download_tasks">Download Tasks CSV</a>
        </button>

        <div class="my-5">
            <div class="text-xl  font-bold leading-7 text-gray-900">Assign New Task</div>
            <?php if(is_admin()){?>
                <form method="POST">
